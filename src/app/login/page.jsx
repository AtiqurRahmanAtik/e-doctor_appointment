...
const login = () => {
    ...
    return (
            ...
            <div className="w-full my-12 max-w-lg mx-auto overflow-hidden bg-white rounded-lg shadow-2xl dark:bg-gray-800">
    <div className="px-6 py-4">
      

       

        <h3 className="mt-3 text-2xl font-medium text-center text-black dark:text-gray-200">Please Login Here</h3>
